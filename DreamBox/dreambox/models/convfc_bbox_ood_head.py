...
class ConvFCBBoxOODHead(ConvFCBBoxHead):
    ...
    def __init__(self,
        ...
        if self.with_ood:
            ...
            self.fc_ood = MODELS.build(ood_predictor_cfg_)
    ...
    def forward(self, x: Tuple[Tensor]) -> tuple:
        ...
        ood_score = self.fc_ood(x_ood) if self.with_ood else None
...
@MODELS.register_module()
class Shared2FCBBoxOODHead(ConvFCBBoxOODHead):
