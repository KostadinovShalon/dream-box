...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='voc0712_train_all_explicit_ood_10k.json'))
val_dataloader = dict(
    batch_size=1,
    dataset=dict(
        type=dataset_type,
...
val_evaluator = dict(
    ...
    outfile_prefix='work_dirs/voc_faster_rcnn_energy_ood_explicit_prompts_10k/id_voc_res')
